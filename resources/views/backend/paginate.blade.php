@if ($paginator->hasPages())
    <ul class="pagination pagination-xs pagination-gutter justify-content-center">
        {{--Previous Page Link--}}
        @if ($paginator->onFirstPage())
            {{--<li class="disabled page-item"><span class="page-link">«</span></li>--}}
        @else
            <li class="page-item page-indicator d-none d-sm-block">
                <a class="page-link" href="{{ $paginator->previousPageUrl() }}" rel="prev" data-page="{{$paginator->currentPage() - 1}}">
        ...
        @if ($paginator->hasMorePages())
            <li class="page-item page-indicator d-none d-sm-block">
                <a class="page-link" href="{{ $paginator->nextPageUrl() }}" rel="next" data-page="{{$paginator->currentPage() + 1}}">
